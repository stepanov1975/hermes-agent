...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-54283/48818/48817 — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.31",  # FastAPI UploadFile/Form for streaming uploads (NS-501); CVE-2026-53538/53539/53540
    ),
    ...
    "tool.computer_use": (
        "mcp==1.26.0",
        "starlette==1.3.1",  # CVE-2026-54283/48818/48817 — keep in sync with pyproject [computer-use]
    ),
}
