...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def sync_turn(self, user_content: str, assistant_content: str, *, session_id: str = "") -> None:
        ...
        # Reserve append turns before handing the job to the writer. The writer
        # may drain immediately, so reserving afterward can overwrite a failed
        # job's rollback and prevent the suffix from being retried.
        if update_mode == "append":
